...
const History = ({ history }) => {
  const count = (_deadline) => {
    ...
    var now = new Date(_deadline*1000).toLocaleDateString("en-US")    ;

    // _deadline = Number(_deadline) * 1000 - now;
    // console.log(_deadline)
    // var now =
    //   new Date().getDate(_deadline) +
    //   "-" +
    //   new Date().getMonth(_deadline) +
    //   "-" +
    //   new Date().getFullYear(_deadline);
    return now;
  };
      ...
      <div className="History-page ">
        <div className="wrap wrapWidth flex">
          <div className="History-box">
            ...
            <div className="flex justify-center items-center w-full mt-12 max-h-[500px] px-8 pt-24">
            ...
            {history.length == 0 ? (
              ...
              >
                Your Have no Transaction History Yet.
              </h1>
            ) : null}
          </div>
        </div>
